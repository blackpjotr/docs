...
Make sure that the necessary dependencies are installed by running `sudo apt install build-essential autoconf automake libtool pkg-config libpng-dev nasm zlib1g-dev`.